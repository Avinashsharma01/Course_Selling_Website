            ...
            <section className="py-20 px-6 md:px-16 flex flex-col lg:flex-row gap-16 max-w-7xl mx-auto">
                <div className="lg:w-1/2 space-y-5">
                    <h2 className="text-3xl md:text-4xl font-bold text-blue-700 mb-4">
                        What Drives{" "}
                        <span className="text-blue-900">Learnify</span>
                    </h2>
                    <p className="text-gray-700 leading-relaxed">
                        At <strong>Learnify</strong>, we are a passionate team
                        dedicated to making quality education accessible to
                        everyone. From expert-led courses to global community
                        support, everything is designed to help learners grow
                        and thrive in their careers.
                    </p>
                    <p className="text-gray-700 leading-relaxed">
                        We empower your growth through flexible learning,
                        real-world projects, and tools aligned with industry
                        demand. Whether you're upskilling or switching paths —
                        we're here for your success.
                    </p>
                    <p className="text-gray-700 leading-relaxed">
                        Our goal is simple: practical, outcome-focused learning
                        that changes lives. Learnify is not just a platform —
                        it’s a launchpad.
                    </p>
                </div>
            ...
            <section className="bg-blue-50 py-20 px-4">
                <div className="max-w-5xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-blue-800 mb-4">
                        Here's Why Learners Choose{" "}
                        <span className="text-blue-600">Learnify</span>
                    </h2>
                    <p className="text-gray-600 text-lg mb-10">
                        Designed to empower you with career-ready skills,
                        community support, and real-world outcomes.
                    </p>
                            ...
                            cardsData={[
                                {
                                    ...
                                    description:
                                        "Courses built for real-world jobs. Gain portfolio-worthy projects and skills recruiters love.",
                                    details:
                                        "Each course is created in collaboration with industry experts and packed with hands-on projects to help you build a strong portfolio. Whether you're learning web dev or data science, we align everything with real-world demand.",
                                    outcome:
                                        "By the end, you're job-ready — not just certificate-ready.",
                                },
                                {
                                    id: 2,
                                    title: "🌐 Global Community",
                                    description:
                                        "Join thousands of learners, mentors & experts worldwide. Grow with global connections.",
                                    details:
                                        "Interact in live sessions, discussion forums, and global networking events. Our vibrant community provides peer support, mentorship, and collaboration opportunities that accelerate your learning.",
                                    outcome:
                                        "You’re never alone on your journey — the world learns with you.",
                                },
                                {
                                    id: 3,
                                    title: "🎓 Real Results",
                                    description:
                                        "Land dream jobs, switch careers or build your own startup — all through Learnify’s outcomes-first learning.",
                                    details:
                                        "We don’t just teach theory — we help you apply what you learn with guided capstone projects, resume reviews, and mock interviews. Learners report job offers from Google, TCS, and rising startups.",
                                    outcome:
                                        "Learning here means changing your life, not just your resume.",
                                },
                            ]}
                        />
                    </div>
