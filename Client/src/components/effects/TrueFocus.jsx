      ...
      {words.map((word, index) => {
        ...
        return (
          <span
            ...
            className="relative text-[2.2rem] sm:text-[2.5rem] md:text-[3rem] font-black cursor-pointer"
            style={{
      ...
      >
        {["top-left", "top-right", "bottom-left", "bottom-right"].map((pos, idx) => (
          <span
            ...
            } ${pos.includes("left") ? "left-[-10px] border-r-0 border-b-0" : "right-[-10px] border-l-0 border-t-0"}`}
            style={{
