                ...
                <div className="flex items-center justify-between w-full">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        >
                            ...
                            <span className="hidden sm:inline-block">Learnify</span>
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        <Link
                            ...
                            className={`text-sm font-medium transition-colors ${
                                isScrolled ? "text-blue-800 hover:text-blue-600" : "text-white hover:text-blue-200"
                            }`}
                        >
                            All Courses
                        </Link>
                            ...
                            <form onSubmit={handleSearch} className="flex">
                                ...
                                <button
                                    ...
                                    className={`rounded-r-md px-3 py-1.5 transition-colors ${
                                        isScrolled ? "bg-blue-600 hover:bg-blue-700 text-white" : "bg-white hover:bg-blue-100 text-blue-700"
                                    }`}
                                >
                                    <FaSearch />
                                </button>
                        ...
                        {!user ? (
                            <div className="flex items-center gap-3">
                                <Link
                                    to="/auth/login"
                                    className={`text-sm font-medium transition-colors ${
                                        isScrolled ? "text-blue-700 hover:text-blue-500" : "text-white hover:text-blue-200"
                                    }`}
                                >
                                    Login
                                </Link>
